...
/**
 * Test de l'API Jena SDB avec le fichier de configuration SDB de PASSIM sur Xeround.
 * TODO S'assurer que le mot de passe / login soient bien références dans les System Properties.
 * 
 * @author ThibWeb
 * @date 13/01/13
 */
public class TestJenaSDB {
	...
	public static void main(String[] args) {
        ...
        // Creating a graph from the Store, and adding it to a general purpose dataset will
        // not necesarily exploit full SQL generation. The right answers will be obtained but slowly.

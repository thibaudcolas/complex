...
/**
 * Test de l'API Jena D2RQ avec le mapping des données de l'ISF sur Heroku Postgres.
 * TODO S'assurer que le mot de passe est bien présent dans le fichier de mapping avant exécution.
 * 
 * @author ThibWeb
 * @date 13/01/13
 */
